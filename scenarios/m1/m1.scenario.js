...
test('(3 pts) (scenario) expected object', () => {
  ...
  const serializedObject = '{"type":"object","value":{"a":{"type":"number","value":"1"}}}'; /* Add here the expected serialized string by using util.serialize */
...
/* Come up with an object that uses all valid (serializable)
  ...
  const object = [[], new Date(), Error(), Object(), true, () => {}, null, 1, {}, '', undefined];
...
/* Come up with a string that is not a valid serialized object. */
  ...
  const malformedSerializedString = '{"type":"number",1}';
